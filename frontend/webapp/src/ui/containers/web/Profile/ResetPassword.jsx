                ...
                <div style={{ height: window.innerHeight, overflow: 'hidden' }}>
                    <Grid container spacing={8}>
                        ...
                        <Grid item xs={6} sm={7} lg={8} xl={8} className={classes.signUpPaper} style={{ padding: "20rem" }}>
                            <Typography align='left' variant='h4' style={{ marginTop: 'auto', marginBottom: "auto", padding: "2% 0%" }}>Reset Password</Typography>
                            <Typography align='left' variant='h6' style={{ padding: "2% 0%" }}>Please choose your new passwords</Typography>
